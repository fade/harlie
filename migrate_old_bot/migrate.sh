...
echo ""
echo "Next steps:"
echo "  1. If you have not yet produced a new config.lisp, connect to the"
echo "     running legacy bot via Slynk and run:"
echo "       (load \"/path/to/migrate-from-legacy.lisp\")"
echo "       (harlie::run-lisp-migration)"
echo "     Review new-config.lisp (written to *syspath*) and copy it"
echo "     into place as config.lisp, then stop the bot."
echo ""
